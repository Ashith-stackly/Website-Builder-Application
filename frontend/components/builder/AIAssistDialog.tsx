...
export function AIGenerateSectionButton({
  ...
  return (
    <button
      ...
      className="inline-flex cursor-pointer items-center gap-1.5 rounded-lg border border-violet-200 bg-violet-50 px-2.5 py-1.5 text-[11px] font-bold text-violet-800 transition hover:border-violet-300 hover:bg-violet-100 focus:outline-none focus:ring-2 focus:ring-violet-300"
        ...
        >
          <header className="sticky top-0 z-10 flex items-start justify-between border-b border-[#eee8e2] bg-[#fffdfb]/95 px-5 py-4 backdrop-blur sm:px-6">
            ...
            <button
              ...
              className="cursor-pointer rounded-lg p-2 text-[#66738d] transition hover:bg-slate-100 hover:text-[#0B1D40] focus:outline-none focus:ring-2 focus:ring-violet-300"
            >
              <X className="h-4 w-4" />
            </button>
          </header>
            ...
            <div className="space-y-5">
                ...
                <div className="flex flex-wrap gap-2">
                  {TONES.map((option) => (
                    <button
                      ...
                      className={`cursor-pointer rounded-full border px-3 py-1.5 text-xs font-bold transition focus:outline-none focus:ring-2 focus:ring-violet-300 ${
                        tone === option.value
                ...
                <div className="grid grid-cols-3 gap-2">
                  {LENGTHS.map((option) => (
                    <button
                      ...
                      className={`cursor-pointer rounded-xl border p-2 text-left transition focus:outline-none focus:ring-2 focus:ring-violet-300 ${
                        length === option.value
              ...
              <div className="grid gap-3 sm:grid-cols-2 md:grid-cols-1 lg:grid-cols-2">
                <label className="block">
                  ...
                  <input
                    ...
                    className="cursor-text w-full rounded-lg border border-[#dce3ed] bg-white px-3 py-2 text-sm text-[#0B1D40] outline-none transition placeholder:text-[#9aa6b9] focus:border-violet-400 focus:ring-2 focus:ring-violet-100"
                  />
                </label>
                <label className="block">
              ...
              <label className="block">
                ...
                <textarea
                  ...
                  className="cursor-text w-full resize-y rounded-lg border border-[#dce3ed] bg-white px-3 py-2 text-sm text-[#0B1D40] outline-none transition placeholder:text-[#9aa6b9] focus:border-violet-400 focus:ring-2 focus:ring-violet-100"
                />
              </label>
              ...
              {isGenerating && (
                <button
                  ...
                  className="cursor-pointer mx-auto block text-xs font-semibold text-[#66738d] underline-offset-2 hover:text-[#0B1D40] hover:underline"
                >
                  Cancel generation
                </button>
              )}
            ...
            <div className="flex min-h-[300px] flex-col rounded-2xl border border-[#e5e9f0] bg-[#f8fafc] p-3 sm:p-4">
              ...
              {error ? (
                ...
                <textarea
                  ...
                  className="cursor-text min-h-[236px] flex-1 resize-y rounded-xl border border-[#dce3ed] bg-white p-3 text-sm leading-6 text-[#1d2f4e] outline-none transition focus:border-violet-400 focus:ring-2 focus:ring-violet-100"
                />
              ) : (
                ...
                <div className="mt-3 flex flex-wrap justify-end gap-2">
                  {target.kind === "field" && (
                    <button
                      type="button"
                      onClick={applyInsert}
                      className="cursor-pointer inline-flex items-center gap-1.5 rounded-lg border border-[#cfd8e6] bg-white px-3 py-2 text-xs font-bold text-[#334563] transition hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-violet-300"
                    >
                  ...
                  <button
                    ...
                    className="cursor-pointer inline-flex items-center gap-1.5 rounded-lg bg-[#0B1D40] px-3 py-2 text-xs font-bold text-white transition hover:bg-[#102a5f] focus:outline-none focus:ring-2 focus:ring-violet-300"
                  >
