  ...
  return (
    <div className="space-y-3">
        ...
        <div key={i} className="space-y-2 rounded-xl border border-[#dbe3ef] p-3">
          <div className="flex items-start gap-2">
            ...
            <button
              ...
              className="cursor-pointer mt-7 shrink-0 rounded p-1 text-[#566583] transition hover:bg-red-50 hover:text-red-500"
      ...
      <button
        type="button"
        onClick={addItem}
        className="cursor-pointer text-[12px] font-bold text-[#0B1D40] transition hover:underline"
      >
        + Add Feature
      </button>
    </div>
