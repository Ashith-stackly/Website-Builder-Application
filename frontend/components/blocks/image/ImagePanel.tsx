    ...
    <div className="space-y-4">
      ...
      <div className="flex gap-2">
        <button
          ...
          className="cursor-pointer flex flex-1 items-center justify-center gap-1.5 rounded-lg bg-blue-600 py-2 text-[12px] font-bold text-white hover:bg-blue-700 transition"
        >
          {hasImage ? (
        ...
        {hasImage && (
          <button
            ...
            title="Remove image"
            className="cursor-pointer flex items-center justify-center rounded-lg border border-gray-200 px-3 py-2 text-gray-400 hover:border-red-200 hover:bg-red-50 hover:text-red-500 transition"
          >
