                                  ...
                                  return (
                                    <li key={c.id} role="presentation" className="px-0 py-0">
                                      <button
                                        ...
                                        className={`flex w-full cursor-pointer items-center gap-2 whitespace-nowrap px-3 py-2 text-left text-sm outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[#1A73E8] ${highlighted
