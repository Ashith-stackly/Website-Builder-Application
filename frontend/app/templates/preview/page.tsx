          ...
          >
            ...
            {searchQuery && (
              <button
                ...
                className="cursor-pointer text-xs font-bold text-gray-400 transition hover:text-gray-600"
              >
                Clear
              </button>
            )}
          ...
          {TEMPLATE_CATEGORIES.map(({ value, label }) => {
            ...
            return (
              <button
                ...
                className={`whitespace-nowrap cursor-pointer rounded-xl px-4 py-2 text-xs font-bold uppercase tracking-wider transition ${
                  isActive
          ...
          {error && (
            ...
            >
              ...
              <button
                ...
                className="inline-flex cursor-pointer items-center gap-1.5 rounded-lg bg-red-100 px-3 py-1.5 text-xs font-bold text-red-700 transition hover:bg-red-200"
              >
        ...
        {!isLoading && !error && templates.length === 0 && (
          ...
          >
            ...
            <button
              ...
              className="inline-flex cursor-pointer items-center gap-2 rounded-xl bg-[#06224C] px-6 py-2.5 text-xs font-bold uppercase tracking-wider text-white transition hover:bg-blue-900"
            >
              View All Templates
            </button>
          </motion.div>
            ...
            {templates.map((template) => (
              ...
              >
                ...
                <div className="flex flex-1 flex-col px-2">
                  ...
                  <div className="flex items-center gap-3">
                    <Link
                      href={template.category === "blog" || template._id === "tpl_blog_1" ? "/blog" : `/templates/preview/?id=${template._id}`}
