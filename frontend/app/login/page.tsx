...
export default function LoginPage() {
  ...
  return (
    <>
      <motion.div className="login-page auth-page relative min-h-[100dvh] lg:min-h-screen flex flex-col max-lg:overflow-auto px-0 py-0 lg:px-6 lg:py-4 lg:overflow-y-auto overflow-hidden bg-[#021a46] bg-gradient-to-b from-[#5f82e8] via-[#3f66c9] to-[#021a46] lg:bg-gradient-to-br lg:from-[#f6fcfe] lg:via-[#e2f2f9] lg:to-[#b2dbeb]" initial="hidden" animate="visible" variants={loginContainerVariants}>
