...
import { isApiConnectionError, verifyMobileOtp, checkOtpPreview } from "@/lib/api";
          ...
          <form onSubmit={handleConfirm} className="space-y-6">
            ...
            >
             ...
             <button
              ...
              onClick={() =>
                router.push(
                  `/forgot-password?changeFrom=verify-mobile&primaryUser=${encodeURIComponent(contact)}`
                )
              }
