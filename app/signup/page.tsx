...
export default function SignupPage() {
  ...
  return (
    <div className="auth-page min-h-[100dvh] lg:min-h-screen flex flex-col bg-transparent lg:bg-white px-0 py-0 lg:px-6 lg:py-4 max-lg:overflow-visible lg:overflow-y-auto">
