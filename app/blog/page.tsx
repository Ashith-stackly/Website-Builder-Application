                  ...
                  >
                    {blogCategories.map((item) => (
                      <button
                        ...
                        type="button"
                        role="menuitem"
                        className={`block w-full max-w-full py-[0.45rem] px-2 rounded-[0.35rem] text-left text-[0.85rem] font-medium border-none cursor-pointer font-inherit transition-colors duration-150 ease focus-visible:bg-[rgba(255,255,255,0.12)] focus-visible:outline-none ${selectedCategory === item.id
                    ...
                    <button
                      type="button"
                      role="menuitem"
                      className={`block w-full max-w-full py-[0.45rem] px-2 rounded-[0.35rem] text-left text-[0.85rem] font-medium border-none cursor-pointer font-inherit transition-colors duration-150 ease focus-visible:bg-[rgba(255,255,255,0.12)] focus-visible:outline-none font-bold ${selectedCategory === "All"
