...
const TEMPLATE_COPY = {
  ...
  construction: {
    primary: '#0a1e3d',
    surface: '#f8f9fa',
    heroTitle: 'Building excellence with precision',
    heroDescription: 'Heavy machinery, project showcases, safety commitments, and expert building contracting.',
    cta: 'Explore projects',
    links: ['Services', 'Projects', 'Safety', 'Contact'],
    featureHeading: 'Construction & engineering capabilities',
    features: [
    ...
    gallery: [
      ['/landing-optimized/construction02.webp', 'Industrial project site'],
      ['/landing-optimized/constrctio10.webp', 'Heavy equipment operation'],
    ],
    contactTitle: 'Request a project quote',
    contactDescription: 'Speak with our contracting engineers about your next build.',
    contactCta: 'Get quote',
    footerTagline: 'Heavy construction, infrastructure, and building contracting.',
  },
  'digital-marketing': {
    primary: '#1e56e5',
    surface: '#f4f6fc',
    heroTitle: 'Accelerate your business growth',
    heroDescription: 'High-converting digital marketing strategies, SEO, brand positioning, and performance campaigns.',
    cta: 'Get started',
    links: ['Services', 'Growth Stats', 'Reviews', 'Contact'],
    featureHeading: 'Growth & marketing capabilities',
    features: [
    ...
    gallery: [
      ['/landing-optimized/business09.webp', 'Marketing agency homepage'],
      ['/landing-optimized/business03.webp', 'Growth analytics dashboard'],
    ],
    contactTitle: 'Schedule a growth consultation',
    contactDescription: 'Let us analyze your current marketing channels and craft a custom growth strategy.',
    contactCta: 'Request call',
    footerTagline: 'Digital marketing, brand growth, and performance campaigns.',
  },
};
...
async function seedTemplates() {
  const baseTemplates = [
    ...
    },
    {
      ...
      previewUrl: '/landing-optimized/construction02.webp',
      style: 'Modern',
    ...
    },
    {
      ...
      description: 'A high-converting digital marketing template with service highlights, trust signals, and strategy booking.',
      thumbnail: '/landing-optimized/business09.webp',
      previewUrl: '/landing-optimized/business09.webp',
      style: 'Modern',
      sections: ['navigation', 'hero', 'features', 'testimonial', 'contact', 'footer'],
      pages: DEFAULT_PAGES,
      tags: ['business', 'marketing', 'agency', 'services'],
      featured: true,
    },
  ];
